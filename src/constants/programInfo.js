...
export const faq = {
  ...
  loanRange: [
    {
      programName:
        "the Full Time Web Development, Part Time Web Development, Data Science Bootcamp, and Full Time Front-End Web Design programs",
      maxAmount: "$10,000",
      col: false,
      colAmount: "$6,000",
    },
...
export const leadContent = {
  ...
  paragraph: `${schoolName} designs its programs to provide students a foundation in web development or data science. ${schoolName} partners with Skills Fund to offer tuition${
...
export const threeStepCardText = {
  ...
  step2: {
    ...
    text:
      "Choose between the Data Science, Data Analytics, Full Time Web Development, Part Time Web Development, and Full Time Front-End Web Design programs.",
  },
...
export const programLoanInfo = [
  // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
  {
    ...
    url: "https://my.skills.fund/application?lenderCode=SKNSHDS19",
    loanInfo: {
  ...
  },
  {
    ...
    url: "https://my.skills.fund/application?lenderCode=SKNASHDS17",
    loanInfo: {
      // match loanInfo in first metro below
      maxLoanAmt: 10000,
      loanTerm36: true,
  ...
  },
  {
    ...
    url: "https://my.skills.fund/application?lenderCode=SKNASHFR17",
    loanInfo: {
      // match loanInfo in first metro below
      maxLoanAmt: 10000,
      loanTerm36: true,
  ...
  },
  {
    ...
    url: "https://my.skills.fund/application?lenderCode=SKNASHWEB1",
    loanInfo: {
      // match loanInfo in first metro below
      maxLoanAmt: 10000,
      loanTerm36: true,
  ...
  },
  {
    ...
    url: "https://my.skills.fund/application?lenderCode=SKNSSWPT17",
    loanInfo: {
      // match loanInfo in first metro below
      maxLoanAmt: 10000,
      loanTerm36: true,
...
export const programMaxText =
  "Choose the loan amount that works best for you. Borrow up to $10,000 for Full-Time Web Development, Part-Time Web Development, Front-End Web Design tuition, or Data Science tuition, or up to $6,000 for Data Analytics tuition."
